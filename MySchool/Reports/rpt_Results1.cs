...
{
    public partial class rpt_Results1 : DevExpress.XtraReports.UI.XtraReport, IGradesReportView
    {
        //GradeReportPersenter GrRePersenter;
        private int classid;
        private int yearid;
        private int termid;
        #region My Property
        ...
        public rpt_Results1(int yrid, int trmid, int clsid)
        {
            InitializeComponent();
            yearid = yrid;
            termid = trmid;
            ...
            //GrRePersenter = new Persenter.GradeReportPersenter(this);
        }
        public rpt_Results1()
        {
            InitializeComponent();
        ...
        public void Print(int yearid, int termid, int classid)
        {
            ...
            ds = ReportDataSuorce(GradesReportOperation.GetAllGrades(yearid, termid, classid));
            rpt.DataSource = ds;
